    ...
    <div className="navbar w-full h-full flex justify-between items-center relative">
      ...
      <div className="auth-user-info flex justify-center items-center gap-2 text-base">
        <button
          ...
          className="p-2 font-semibold text-white bg-black hover:bg-white hover:font-bold hover:outline hover:outline-black transition-all hover:text-black text-sm block mr-2 rounded"
        >
          Checkout
        </button>
