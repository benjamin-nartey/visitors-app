...
function NavBar() {
  ...
  const { setOpen, open } = useContext(CheckOutToggleContext);
    ...
    <div className="navbar w-full flex justify-between items-center ">
      ...
      <div className="auth-user-info flex justify-center items-center gap-2 text-base">
        <button
          ...
          className="p-2 font-semibold text-white bg-green-700 hover:bg-white hover:font-bold hover:outline hover:outline-green-700 transition-all hover:text-black text-sm block mr-2 rounded"
        >
          Checkout
        </button>
